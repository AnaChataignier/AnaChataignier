...
<img width=100% src="https://capsule-render.vercel.app/api?type=waving&color=00bfbf&height=120&section=footer"/>
  ...
  <h5 align="center">Sou a Ana, tenho 25 anos e moro no Rio de Janeiro. Embarquei na jornada da programação em 2020 onde conheci o trabalho do mestre Gustavo Guanabara e me apaixonei. Posso dizer que graças ao Guanabara ganhei uma sólida base de Python, MySQL, HTML, Git e GitHub. Depois mergulhei de cabeça na espetacular plataforma da Alura para dar continuidade e me aprofundar no desenvolvimento backend aprendendo POO, Django, Django REST Framework, Construindo API's e interagindo com API's de terceiros. Sigo firme aprendendo e evoluindo na Alura, e hoje me encontro Finalizando uma formação técnica em Desenvolvimento Web - Python no SENAC-RJ, mais uma conquista! Recentemente entrei para o programa de formação a distância pela CS50 e Harvard, onde estou tendo aulas maravilhosas sobre Ciência da Computação.
